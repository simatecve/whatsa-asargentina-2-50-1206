  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/20 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      <div className="space-y-8 p-6">
        ...
        <div className="relative overflow-hidden bg-gradient-to-r from-slate-600 via-blue-600 to-indigo-600 p-8 rounded-2xl shadow-2xl border border-slate-200/20">
          <div className="absolute inset-0 bg-gradient-to-r from-slate-600/90 to-indigo-600/90"></div>
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-slate-100 text-lg mt-1">
              ...
              <div className="flex items-center gap-6 text-slate-100">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">Configuración segura</span>
                </div>
                <div className="flex items-center gap-2">
