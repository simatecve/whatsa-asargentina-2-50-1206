...
interface CampanaFormInstanceSelectProps {
  form: UseFormReturn<any>;
}

export const CampanaFormInstanceSelect = ({ form }: CampanaFormInstanceSelectProps) => {
  ...
  return (
    <div>
      <div className="flex items-center mb-2">
        ...
        <h3 className="font-medium">Seleccionar Instancia</h3>
      </div>
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            <FormLabel>Instancia para envío</FormLabel>
            <Select 
